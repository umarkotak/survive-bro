...
interface CharacterSummary { id: string; name: string; spriteId: string; maxHp: number; armorPercent: number; movementSpeed: number; healthRegeneration: number; attackBuffPercent: number; cooldownPercent: number; baseSpell: { id: string; damage: number; cooldownMs: number; projectileSpeed: number; burst: number; directions: number } }
