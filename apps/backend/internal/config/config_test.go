...
func TestLoadDefaults(t *testing.T) {
	...
	if !reflect.DeepEqual(cfg.AllowedOrigins, []string{"http://localhost:3702", "http://127.0.0.1:3702", "https://survive-bro-dev.cabocil.com", "https://survive-bro.cabocil.com"}) {
